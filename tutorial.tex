...
\begin{itemize}
	...
	\item Press \keystroke{Shift}+\keystroke{j} to zoom out.
	\item Press \keystroke{Shift}+\keystroke{k} to zoom in.
	...
	\item Enter \keystroke{gg} to go to the first page. In order to go to a specific page, enter \verb+[NUM]+\keystroke{gg} where \verb+[NUM]+ is the page number. For example in order to go to page 31, enter \keystroke{31gg}. You can also press \keystroke{Home} to go to a specific page.
	...
	\item  With some text selected, press \keystroke{wss} to search the text in Google Scholar and \keystroke{wsl} to search it in Library Genesis. Try it out on the following texts:\\
